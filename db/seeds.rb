...
Task.create!([
  ...
  {title: "Start to write the new project proposal ", completed: false, repeats: false, user_id: 1, estimate: "~1 day", startDate: 1490227200.0, endDate: 1490400000.0, list_id: 3},
  ...
  {title: "leg day", completed: false, repeats: false, user_id: 1, estimate: "", startDate: nil, endDate: nil, list_id: 5},
  {title: "back day", completed: false, repeats: false, user_id: 1, estimate: "", startDate: nil, endDate: nil, list_id: 5},
  {title: "arm day ", completed: false, repeats: false, user_id: 1, estimate: "", startDate: nil, endDate: nil, list_id: 4},
...
User.create!([
  {email: "mikeisgreate@gmail.com", username: "Mike Epps", session_token: "mVE7QzArfmYYj0uRbw34Bw", password_digest: "$2a$10$Dw/MssxbkABPYz4Epwn6a.qnmCQDYbSl7JsMyhnqpAdB253y7.z5K"}
])
